...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/teste_integracao_com_c/teste_projeto_pratico_wrapper_de_biblioteca_c.zig"),
            .target = target,
            .optimize = optimize,
    ...
    // 1. Adiciona o caminho do cabeçalho clog.h (localizado em include/)
    exe.root_module.addIncludePath(b.path("include/"));

    // 2. Compila a implementação C da nossa biblioteca junto com o projeto
    exe.root_module.addCSourceFile(.{
        .file = b.path("src/teste_integracao_com_c/clog.c"),
        .flags = &.{ "-std=c99" },
    });
